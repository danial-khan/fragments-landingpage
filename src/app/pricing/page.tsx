...
const Pricing = () => {
  ...
  return (
    <div>
      <Navbar />
      <main className="bg-[var(--background-alt)] py-10 md:px-10 px-4">
        <h1 className="font-bold md:text-3xl text-2xl text-center">
        Choose Your Fragments Journey
        </h1>
        <p className="text-[var(--text-muted)] mt-3 md:text-lg text-sm text-center">
          ...
          <div className="container mx-auto px-4 pb-8">
            ...
            <div className="mt-10 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                {/* Basic Learner */}
                <div className="bg-white shadow-lg rounded-lg p-6 border border-[var(--border-pale)] text-center">
                  <h3 className="text-2xl font-semibold text-[var(--text-dark)]">
                    Basic Learner
                  </h3>
                  <div className="text-4xl font-bold text-secondary mt-4">
                    $5 <span className="text-lg text-[var(--text-muted)]">/month</span>
                  </div>
                  <p className="text-[var(--text-muted)] mt-2 text-sm">
                    Perfect for curious minds starting their learning journey
                  </p>
                  <ul className="mt-6 space-y-3 text-[var(--text-muted)] text-left">
                    <li>✔ Access to all fragments</li>
                    <li>✔ Join fragment trails</li>
                    <li>✔ Basic discussion participation</li>
                    <li className="text-[var(--accent-orange-dark)]">⚠ Contains advertisements</li>
                  </ul>
                  <a
                ...
                <div className="bg-white shadow-xl rounded-lg p-6 border-2 border-secondary relative text-center transform hover:scale-105 transition-transform">
                  ...
                  <h3 className="text-2xl font-semibold text-[var(--text-dark)] mt-2">
                    Pro Learner
                  </h3>
                  <div className="text-4xl font-bold text-secondary mt-4">
                    $15 <span className="text-lg text-[var(--text-muted)]">/month</span>
                  </div>
                  <p className="text-[var(--text-muted)] mt-2 text-sm">
            ...
            <div className="mt-12">
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div className="bg-white shadow-lg rounded-lg p-6 border border-[var(--border-pale)] text-center">
                  ...
                  <div className="text-4xl font-bold text-secondary mt-4">
                    $20 <span className="text-lg text-[var(--text-muted)]">/month</span>
                  </div>
                  <p className="text-[var(--text-muted)] mt-2 text-sm">
                ...
                {/* Pro Educator */}
                <div className="bg-white shadow-lg rounded-lg p-6 border-2 border-[var(--accent-orange)] text-center transform hover:scale-105 transition-transform">
                  <div className="flex items-center justify-center mb-2">
                    <span className="border-[var(--accent-orange)] text-white text-xs uppercase px-3 py-1 rounded-full font-bold">
                      Premium
                    </span>
                  </div>
                  <h3 className="text-2xl font-semibold text-[var(--text-dark)]">
                  ...
                  <div className="text-4xl font-bold text-secondary mt-4">
                    $30 <span className="text-lg text-[var(--text-muted)]">/month</span>
                  </div>
                  <p className="text-[var(--text-muted)] mt-2 text-sm">
                  ...
                  <a
                    ...
                    className="mt-6 w-full bg-gradient-to-r from-[var(--accent-orange)] to-[var(--accent-orange-dark)] text-white hover:from-[var(--accent-orange-dark)] hover:to-[var(--accent-orange-darker)] font-bold py-2 px-6 rounded-lg transition cursor-pointer block text-center"
                  >
                    Get Started
                  </a>
                </div>
        ...
        <section className="container mx-auto py-4 md:py-12 lg:max-w-2xl md:max-w-xl max-w-lg">
          <h2 className="md:text-3xl text-2xl font-bold text-center text-[var(--text-dark)]">
          ...
          <div className="mt-10 max-w-3xl mx-auto space-y-4">
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              <button
                className="w-full text-left px-6 py-4 flex justify-between items-center font-semibold text-[var(--text-dark)] hover:bg-gray-100 transition"
                onClick={() => toggleFAQ(1)}
              >
              ...
              {activeFAQ === 1 && (
                <div className="px-6 py-4 text-[var(--text-muted)]">
