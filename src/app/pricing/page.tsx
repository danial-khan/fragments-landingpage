  ...
  return (
    <div>
      ...
      <main className="bg-bgAlt py-10 md:px-10 px-4">
        ...
        <p className="text-textMuted mt-3 md:text-lg text-sm text-center">
            ...
            <div className="mt-10 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div className="bg-white shadow-xl rounded-lg p-6 border-2 border-secondary relative text-center transform hover:scale-105 transition-transform">
                  ...
                  <h3 className="text-2xl font-semibold text-textDark mt-2">
                    Pro Learner
                  </h3>
                  <div className="text-4xl font-bold text-secondary mt-4">
                    $15 <span className="text-lg text-textMuted">/month</span>
                  </div>
                  <p className="text-textMuted mt-2 text-sm">
            ...
            <div className="mt-12">
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div className="bg-white shadow-lg rounded-lg p-6 border border-border-pale text-center">
                  ...
                  <div className="text-4xl font-bold text-secondary mt-4">
                    $20 <span className="text-lg text-textMuted">/month</span>
                  </div>
                  <p className="text-textMuted mt-2 text-sm">
                ...
                {/* Pro Educator */}
                <div className="bg-white shadow-lg rounded-lg p-6 border-2 border-accent text-center transform hover:scale-105 transition-transform">
                  <div className="flex items-center justify-center mb-2">
                    <span className="bg-accent text-white text-xs uppercase px-3 py-1 rounded-full font-bold">
                      Premium
                    </span>
                  </div>
                  <h3 className="text-2xl font-semibold text-textDark">
                  ...
                  <div className="text-4xl font-bold text-secondary mt-4">
                    $30 <span className="text-lg text-textMuted">/month</span>
                  </div>
                  <p className="text-textMuted mt-2 text-sm">
        ...
        <section className="container mx-auto py-4 md:py-12 lg:max-w-2xl md:max-w-xl max-w-lg">
          <h2 className="md:text-3xl text-2xl font-bold text-center text-textDark">
          ...
          <div className="mt-10 max-w-3xl mx-auto space-y-4">
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              <button
                className="w-full text-left px-6 py-4 flex justify-between items-center font-semibold text-textDark hover:bg-gray-100 transition"
                onClick={() => toggleFAQ(1)}
              >
              ...
              {activeFAQ === 1 && (
                <div className="px-6 py-4 text-textMuted">
